...
import { setUserLike, getDataUser } from "../../redux/auth/auth.actions";
export const Post = ({
	id,
	title,
	createdAt,
					...
					<ul className={styles.postDetails}>
						...
						<li>
							<Button
								...
								disabled={!isLoading && data.likesPostArray.includes(id)}
							>	
								{!isLoading && data.likesPostArray.includes(id) ? <ThumbUpFill /> : <ThumbUp />}
							</Button>
